<%@ page contentType="text/html; charset=utf-8" pageEncoding="UTF-8" language="java" import="com.actionForm.ManagerForm" errorPage="/error.jsp" %>
                                    ...
                                    <form name="form1" method="post" action="manager.do?action=managerModify">
                                        <table height="126" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td width="190">
                                                    <input name="id" type="hidden" value="<%=ID%>"><input name="name"
                                                                                                          type="text"
                                                                                                          readonly="yes"
                                                                                                          value="<%=name%>">
                                                </td>
                                                    ...
                                                    <table width="100%" height="67" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td width="47%"><input name="sysset" type="checkbox"
                                                                                   ...
                                                                                   value="1" <%if(sysset==1){out.println("checked");}%>>
                                                                系统设置
                                                            </td>
                                                            <td width="53%"><input name="readerset" type="checkbox"
                                                                                   class="noborder" id="readerset"
                                                                                   value="1" <%if(readerset==1){out.println("checked");}%>>
                                                                读者管理
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><input name="bookset" type="checkbox" class="noborder"
                                                                       id="bookset"
                                                                       value="1" <%if(bookset==1){out.println("checked");}%>>
                                                                图书管理
                                                            </td>
                                                            <td><input name="borrowback" type="checkbox"
                                                                       class="noborder" id="borrowback"
                                                                       value="1" <%if(borrowback==1){out.println("checked");}%>>
                                                                图书借还
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="23"><input name="sysquery" type="checkbox"
                                                                                   ...
                                                                                   value="1" <%if(sysquery==1){out.println("checked");}%>>
                                                                系统查询
                                                            </td>
                                                            <td>&nbsp;</td>
                                                        </tr>
