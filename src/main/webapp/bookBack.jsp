                        ...
                        <tr>
                            <td height="510" align="center" valign="top" style="padding:5px;">
                                <table width="98%" height="487" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td height="22" valign="top" class="word_orange">当前位置：图书借还 &gt; 图书归还 &gt;&gt;&gt;</td>
                                    </tr>
                                    <tr>
                                                                    ...
                                                                    <td valign="top">
                                                                        <table width="100%" height="35" border="1"
                                                                            ...
                                                                            <tr align="center" bgcolor="#e3F4F7">
                                                                                ...
                                                                                <td width="12%" bgcolor="#F0FAFB" align="center">
                                                                                    操作
                                                                                </td>
                                                                            </tr>
                                                                            <%
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="12%" align="center"><a
                                                                                        href="borrow.do?action=bookback&barcode=<%=barcode%>&id=<%=id%>&operator=<%=chStr.toChinese(manager)%>">归还</a>&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                            <% }
                                                                            %>
