                        ...
                        <table width="100%" height="131" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" valign="top">
                                    <form name="form1" method="post" action="readerType.do?action=readerTypeModify">
                                        ...
                                        <table width="100%" height="111" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td width="72%"><input name="name" type="text" size="28"
                                                                       value="<%=chStr.toChinese(readerTypeForm.getName())%>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">可借数量：</td>
                                                <td><input name="number" type="text" size="25"
                                                           value="<%=readerTypeForm.getNumber()%>">
                                                    (本)
                                                </td>
                                            </tr>
                                            <tr>
