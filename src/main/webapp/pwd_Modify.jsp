                                            ...
                                            <form name="form1" method="post" action="manager.do?action=modifypwd">
                                                <table width="47%" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <td width="73%" align="left">
                                                            <input name="name" type="text" id="name"
                                                                   value="<%=chStr.toChinese(managerForm.getName())%>"
                                                                   readonly="yes" size="30"></td>
                                                    <tr>
                                                        <td align="left" style="padding:5px;">原密码：</td>
                                                        <td align="left"><input name="oldpwd" type="password"
                                                                                id="oldpwd" size="30">
                                                            <input name="holdpwd" type="hidden" id="holdpwd"
                                                                   value="<%=chStr.toChinese(managerForm.getPwd())%>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left"><input name="pwd1" type="password" id="pwd1"
                                                                                size="30"></td>
                                                    </tr>
                                                    <tr>
